...
| **Metric thành công** | Trong pilot, ≥ **85%** ticket được gán đúng *nhóm hệ thống* trong top-3; giảm median thời gian tiếp nhận xuống **≤ 4 phút/ticket**; ≥ **95%** case có dấu hiệu an toàn cao được gắn cờ để chuyển người phụ trách ngay. |
